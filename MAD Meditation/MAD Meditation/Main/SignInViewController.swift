...
class SignInViewController: UIViewController {
    ...
    //@IBAction func signInAction(_ sender: UIButton) {
       ...
       // guard inputEmail.text?.isEmpty == false && inputPassword.text?.isEmpty == false else { return showAlert(message: "Поля пустые") }
       // guard isValidEmail(emailID: inputEmail.text!) else { return showAlert(message: "Проверьте правильность почты") }
